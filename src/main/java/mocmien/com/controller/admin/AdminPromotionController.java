...
public class AdminPromotionController {
    ...
    public ResponseEntity<?> getPromotionById(@PathVariable Integer id) {
        try {
            AdminPromotionResponse promotion = adminPromotionService.getPromotionById(id);
    ...
    public ResponseEntity<?> updatePromotion(
            ...
            @RequestParam(value = "banners", required = false) MultipartFile[] banners) {
        try {
            adminPromotionService.updatePromotion(id, name, type, value, ribbon, startDate, endDate, banners);
