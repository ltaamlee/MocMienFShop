...
async function loadPromotionStats() {
	...
	document.getElementById('totalPromotionsStat').textContent = s.totalPromotions || 0;
	document.getElementById('inactivePromotionsStat').textContent = s.inactivePromotions || 0;
	document.getElementById('activePromotionsStat').textContent = s.activePromotions || 0;
	document.getElementById('expiringPromotionsStat').textContent = s.expiringSoonPromotions || 0;
	document.getElementById('expiredPromotionsStat').textContent = s.expiredPromotions || 0;
}
